...
const CURRICULUM = [
  {
    ...
    content: `
      ...
      <div class="callout">
        <div class="callout-title">Adaptives Denken — was steckt dahinter?</div>
        <p>Sonnet 5, Opus 4.8 und Fable 5 entscheiden automatisch und ohne Zutun, wie viel Zeit sie sich für eine Antwort nehmen: Bei einer einfachen Frage antworten sie sofort, bei einer komplexen Analyse denken sie im Hintergrund länger nach — ein manuelles Umschalten ist nicht mehr nötig. Nur Haiku 4.5 verzichtet bewusst darauf, um maximale Geschwindigkeit zu behalten.</p>
      </div>
      <div class="callout">
  ...
  },
  {
    ...
    content: `
      ...
      <h4>Research</h4>
      <p>Für besonders umfangreiche Recherchen bietet Claude einen eigenen Modus namens <strong>„Research"</strong> (häufig auch „Deep Research" genannt): Claude plant selbstständig mehrere Rechercheschritte und fasst die Ergebnisse am Ende in einem strukturierten Bericht zusammen — statt nur eine einzelne Websuche durchzuführen.</p>
      <h4>Dateianalyse</h4>
      <p>PDFs, Excel- oder Word-Dokumente lassen sich direkt hochladen. <strong>Pro-Tipp:</strong> Stelle die <em>Effort-Einstellung</em> (Dropdown neben der Modellauswahl) auf „Hoch" oder „Maximal", damit Claude sich mehr Zeit nimmt, die Datei gründlich einzulesen. Stelle konkrete Fragen <em>zu</em> dem Dokument statt einer Pauschal-Zusammenfassung; mehrere Dateien kann Claude auch <strong>vergleichen</strong>.</p>
    ...
    `,
    quiz: [
      { q: 'Du analysierst eine 100-seitige Marktstudie als PDF und möchtest extrem präzise Details zu einer Nischenkennzahl extrahieren. Welches Vorgehen ist am effektivsten?', options: ['Nutze das Haiku-Modell für maximale Geschwindigkeit beim Scannen.', 'Setze im Opus-Modell die Effort-Einstellung auf „Hoch" oder „Maximal".', 'Lade die Datei im Inkognitomodus hoch, damit die KI sich nicht an alte Chats erinnert.', 'Kopiere den gesamten Text der PDF manuell in die Chatzeile statt die Datei hochzuladen.'], correct: 1, explanation: 'Opus + hohe Effort-Einstellung = Claude liest die Datei gründlicher ein und liefert präzisere Antworten bei komplexen Dokumenten.' },
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'Lange Konversationen aktivieren immer Adaptives Denken',
...
const FINAL_EXAM = [
  ...
  { q: 'Welche Funktion ermöglicht Claude, hunderte Quellen in Sekunden zu durchsuchen?', options: ['Eine hohe Effort-Einstellung', 'Die Websuche über das Plus-Symbol mit belegten Quellenlinks', 'Ein Konnektor zu Google Scholar', 'Das Opus-Modell in der Pro-Version'], correct: 1, explanation: 'Die Websuche (Plus-Symbol) erlaubt Claude, aktuelle Daten und Quellen live zu recherchieren.' },
  { q: 'Warum empfiehlt sich eine hohe Effort-Einstellung bei der Analyse großer PDFs?', options: ['Er erhöht die Upload-Geschwindigkeit', 'Er aktiviert automatisch die Websuche', 'Sie gibt Claude mehr Rechenzeit, um die Datei gründlicher einzulesen und präziser zu antworten', 'Er wandelt PDFs in Excel-Tabellen um'], correct: 2, explanation: 'Eine hohe Effort-Einstellung erhöht die Analysetiefe.' },
  ...
  { q: 'Warum ist es sinnvoll, projektbezogene Dokumente direkt in ein Claude Project hochzuladen?', options: ['Sie stehen in jedem Projekt-Chat bereit, ohne jedes Mal neu hochgeladen zu werden', 'Claude verarbeitet sie dreimal schneller', 'Dokumente werden in strukturierte Wissenseinträge umgewandelt', 'Nur Project-Dateien funktionieren mit einer hohen Effort-Einstellung'], correct: 0, explanation: 'Projektdokumente sind dauerhaft verfügbar — Claude greift automatisch darauf zu.' },
  ...
  { q: 'Welche Voraussetzung gilt für die Nutzung von Claude Cowork?', options: ['Die Claude Desktop-App, verfügbar auf jedem bezahlten Plan (Pro, Max, Team, Enterprise)', 'Ein kostenloses Konto im mobilen Browser', 'Ausschließlich ein Team-Vertrag über die Web-Oberfläche', 'Eine Server-Installation im Unternehmensnetzwerk'], correct: 0, explanation: 'Cowork läuft über die Desktop-App (Mac/Windows) und ist auf jedem bezahlten Plan enthalten — nicht nur mit Pro. Web und Mobile befinden sich für die Fernsteuerung im Beta-Rollout.' },
